      ...
      >
        ...
        <Card className="border">
          ...
          <CardHeader className="text-center">
            <CardTitle className="birthday">Happy 21 Birthday!</CardTitle>
            <CardDescription className="Name">Maham Babar</CardDescription>
            <p className="Dob">November 18</p>
          </CardHeader>
          {/* Card content with candles and balloons */}
          <CardContent className="space-y-6 text-center">
            {/* Candles section */}
            <div>
              <h3 className="light">Light the candles:</h3>
            ...
            {/* Balloons section */}
            <div>
              <h3 className="pop">Pop the balloons:</h3>
              <div className="flex justify-center space-x-2">
